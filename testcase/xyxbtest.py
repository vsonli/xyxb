...
# get_send_post(url,teacher_heads,couse_data,timeout)
# time.sleep(5)
...
# start_data={'duration':180,'groupCode':'196F0b9C1b282Da069DA0488b64834C0','courseCode':couse_data}
# time.sleep(5)
# urls = 'http://192.168.0.207:8081/xyxb/specialColumnCenter/listGroupKey'
# get_send_post(urls,teacher_heads,couse_data,timeout)
# time.sleep(10)
# '''结束直播'''
